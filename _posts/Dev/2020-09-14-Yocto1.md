...
bitbake rpi-basic-image # ssh 연결시
```
...
- bmaptool을 이용하여 sdcard로 복사한다.
	...
	# or
	# sudo bmaptool copy rpi-basic-image-raspberrypi3.wic.bz2 /dev/{DB_PATH}
    
    
    cd {HOME_PATH}/poky/build/tmp/deploy/images/raspberrypi3
    sudo bmaptool copy rpi-basic-image-raspberrypi3.wic.bz2 /dev/sdb1
